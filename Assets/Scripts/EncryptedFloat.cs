namespace WhiteCheatEngine.EncryptedFloat
{
	using Common;
	...
	[Serializable]
	public struct EncryptedFloat : IFormattable, IEquatable<EncryptedFloat>, IComparable<EncryptedFloat>, IComparable<float>, IComparable
	{
		/*
...
#pragma warning restore 414
		...
		private EncryptedFloat(float value) : this()
		{
...
*/
		...
		*/
		...
		{
			var instance = new EncryptedFloat();
		...
		private float InternalDecrypt()
		{
			...
			if (Detector.EncryptedCheatingDetector.ExistsAndIsRunning && fakeValueActive && Math.Abs(decrypted - fakeValue) > Detector.EncryptedCheatingDetector.Instance.floatEpsilon)
			{
		...
		{
			return new EncryptedFloat(value);
		}
		...
		public static EncryptedFloat FromEncrypted(int encrypted) { throw new Exception(); }
